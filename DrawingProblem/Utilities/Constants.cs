...
namespace DrawingProblem.Utilities
{
    static class Constants
    {
        ...
        public const string ExitMessage = "!!!!!Press enter to exit application!!!!!!";
        public const string ImproperCreateCommandMessage = "Create command should have 3 arguments";
